import { errorFromResponse, YandexApiError } from './errors.js'
...
export class YandexClient {
    ...
    private async withRetry(
        ...
        for (;;) {
            try {
                ...
                const retryable =
                    err instanceof YandexApiError ? err.isRetryable : true
    ...
    private async doFetch(
        ...
        try {
            ...
            // Map transport-level failures to a YandexApiError (status 0) so the
