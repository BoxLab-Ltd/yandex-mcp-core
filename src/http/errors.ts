...
/** Shape of a Yandex API error body. */
...
/**
 * An error returned by the Yandex API (non-2xx response) or raised while
...
/** Build a YandexApiError from a non-2xx Response and its (maybe-JSON) body. */
